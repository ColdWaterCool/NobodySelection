...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, prefix, swaggerConfig, document_1, swaggerPath, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    prefix = configService.get('APP_PREFIX', '/api');
                    ...
                    if (configService.get('SWAGGER_ENABLED', true)) {
                        ...
                        swaggerPath = configService.get('SWAGGER_PATH', 'docs');
                ...
                case 2:
                    ...
                    console.log("Swagger documentation: http://localhost:".concat(port, "/").concat(configService.get('SWAGGER_PATH', 'docs')));
                    return [2 /*return*/];
            }
        });
    });
