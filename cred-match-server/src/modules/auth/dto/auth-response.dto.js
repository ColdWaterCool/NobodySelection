...
var AuthResponseDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _accessToken_decorators = [(0, swagger_1.ApiProperty)({ description: '访问令牌' })];
            _refreshToken_decorators = [(0, swagger_1.ApiProperty)({ description: '刷新令牌' })];
            _expiresIn_decorators = [(0, swagger_1.ApiProperty)({ description: '过期时间（秒）' })];
            _user_decorators = [(0, swagger_1.ApiProperty)({ description: '用户信息' })];
