        ...
        HttpExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            if (exception instanceof common_1.HttpException) {
                ...
                if (typeof exceptionResponse === 'object' && exceptionResponse !== null) {
                    var response_1 = exceptionResponse;
                    message = response_1.message || exception.message;
                    code = response_1.code || this.getErrorCode(status);
                ...
                message = exception.message;
                this.logger.error("Unexpected error: ".concat(exception.message), exception.stack);
            }
            var errorResponse = {
                code: status,
                message: message,
