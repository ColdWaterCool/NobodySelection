...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.findByPhone(createUserDto.phone)];
                        case 1:
                            ...
                            if (!createUserDto.password) return [3 /*break*/, 3];
                            _a = user;
                            return [4 /*yield*/, bcrypt.hash(createUserDto.password, 10)];
                        case 2:
                            _a.password = _b.sent();
                            _b.label = 3;
                        case 3: return [2 /*return*/, this.userRepository.save(user)];
                    }
                });
            });
        };
        ...
        UserService_1.prototype.findByPhone = function (phone) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userRepository.findOne({ where: { phone: phone } })];
                });
            });
        };
        UserService_1.prototype.findByWechatOpenid = function (openid) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userRepository.findOne({ where: { wechat_openid: openid } })];
                });
            });
        };
        ...
        UserService_1.prototype.updateLastLogin = function (id, ip) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.update(id, {
        ...
        UserService_1.prototype.updatePassword = function (id, password) {
            return __awaiter(this, void 0, void 0, function () {
                var hashedPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UserService_1.prototype.incrementTokenVersion = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository
                                ...
                                .set({ token_version: function () { return 'token_version + 1'; } })
                                .where('id = :id', { id: id })
                                .execute()];
                        case 1:
                            _a.sent();
        ...
        UserService_1.prototype.validatePassword = function (user, password) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!user.password) {
        ...
        UserService_1.prototype.bindWechatOpenid = function (userId, openid, unionid) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UserService_1.prototype.createOrUpdateByWechat = function (userInfo) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findByWechatOpenid(userInfo.openid)];
                        case 1:
                            user = _a.sent();
                            if (user) {
